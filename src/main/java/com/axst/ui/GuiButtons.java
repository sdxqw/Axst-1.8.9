...
public class GuiButtons extends GuiButton {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if(this.visible) {
            ...
            GuiUtils.drawRoundOutline(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 4.0f, 1.0f, this.enabled ? (this.hovered ? new Color(0, 0, 0, 170).getRGB() : new Color(0, 0, 0, 220).getRGB()) : new Color(0, 0, 0, 240).getRGB());
            ...
            FontUtil.normal.drawCenteredString(this.displayString, this.xPosition + (this.width >> 1), this.yPosition + ((this.height - 8) >> 1), new Color(255,255,255).getRGB());
